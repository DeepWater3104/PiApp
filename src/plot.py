def update_heatmap(data, heatmap, params):
    ...
    #plt.draw() # cannot draw from subprocess
...
if __name__ == '__main__':
    ...
    print(str(network_params['num_neurons_offset'])
          + " "
          + str(network_params['num_neurons_offset'] + network_params['num_neurons_each'] - 1)
)
